...
import {LoginHeader} from '../cmps/login-signup-header'
        ...
        return (<section className="login-signup-container">
            ...
            {pageMode === 'login' && <div className="login-signup flex column">
                ...
                <GoogleLogin
                    ...
                    clientId='900522146438-q7vvlhv5tjnnh4pdvs7mv2c133sbnmpi.apps.googleusercontent.com'
